    ...
    return(
        <div className='sidebar' id='sidebar'>
            ...
            <div className='sidebar-item right'>
                <div className='close-menu' id='close-menu' onClick={()=>{
                ...
                <ul id='sidebar-menu' className='sidebar-menu'>
                    <li>
                        <a className='sidebar-dropdown-menu' onClick={()=>
                            {
                                if(featuresdropdown == false)
                                {
                                    document.getElementById("sidebar-features").style.display = "block";
                                }
                                else
                                {
                                    document.getElementById("sidebar-features").style.display = "none";
                                }
                        ...
                        <ul id='sidebar-features' className="sidebar-features-menu">
                    ...
                    <li>
                        <a className='sidebar-dropdown-menu' onClick={()=>
                            {
                                ...
                                {
                                    document.getElementById("sidebar-company").style.display = "block";
                                }
                                else
                                {
                                    document.getElementById("sidebar-company").style.display = "none";
                        ...
                        <ul id='sidebar-company' className='sidebar-company-menu'>
                            <li><a>History</a></li>
                            <li><a>Our Team</a></li>
                            <li><a>Blog</a></li>
                        </ul>
                ...
                <ul id='sidebar-login-register' className='sidebar-login-register'>
                    <li><a>Login</a></li>
                    <li>
